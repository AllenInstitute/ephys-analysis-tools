...
col_order = ['recording_date', 'cell_name', 'cell_id', 'tube_id', 'rig_operator', 'roi_result_id', 'roiresult_workflow_state', 
             ...
             'ramps_fail_fx_message', 'longsquares_fx', 'shortsquares_fx', 'ramps_fx']
...
new_file_name = "electrophysiology_pipeline_stim_metrics_" + start_date + "_" + end_date + ".csv"
full_dash_data.to_csv(os.path.join(data_path, new_file_name), index=False)
